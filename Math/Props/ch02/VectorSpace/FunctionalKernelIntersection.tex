...
\begin{proof}
   ...
   Let $Q:V \to V/Kernel(S)$ be the \QuotientMap. 
   By 
   \ref{prop:LinearOperatorQuotient}, 
   $\tilde{S}:V/Kernel(S) \to \bbF^n$ defined by $\tilde{S}([x])=S(x)$
   is a
   \Linear \Bijection which satisfies
