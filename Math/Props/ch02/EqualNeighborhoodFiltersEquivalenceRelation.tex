...
\begin{prop}[\RelationOfEqualNeighborhoodFilters is \EquivalenceRelation]
    ...
    \begin{proof}
        ...
        Suppose $x \cong y$. 
        Then  
        $\NeighborhoodFilterInstance{\scTopology{Z}{\T}}\pa{x} = \NeighborhoodFilterInstance{\scTopology{Z}{\T}}\pa{y}$, 
        ...
        Then, 
         $\NeighborhoodFilterInstance{\scTopology{Z}{\T}}\pa{x} = \NeighborhoodFilterInstance{\scTopology{Z}{\T}}\pa{y} = \NeighborhoodFilterInstance{\scTopology{Z}{\T}}\pa{z}$
         so that $x \cong z$.
