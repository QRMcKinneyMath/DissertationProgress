\begin{prop}[Quotient Space Topology]
    ...
    \begin{enumerate}[label=(\roman*), ref={\ref{prop:QuotientSpaceTopology}.~\roman*}]
        \item 
        \label{prop:QST:IsTop}
        $\T_{Z/\cong}$ is a \Topology on $Z/\cong$. 
        \item 
        \label{prop:QST:QuotientMapContinuous}
        $T:(Z, \T_Z) \to (Z/\cong, \T_{Z/\cong})$ is 
        \ContinuousFunction. 
        \item 
        \label{prop:QST:OpenSetsPartition}
        If U is \SetOpen (\SetClosed) in $(Z,\T_Z)$, 
        then $T(U)$ and $T(Z\setminus U)$ \Partition $Z/\cong$. 
        \item 
        \label{prop:QST:OpenSetFiber}
        If U is \SetOpen in $(Z, \T_Z)$, then $U$ is a \Fiber.
        \item 
        \label{prop:QST:ClosedSetFiber}
        If K is \SetClosed in $(Z,\T_Z)$, then $K$ is a \Fiber.
        \item 
        \label{prop:QST:QuotientMapOpen}
        $T:(Z, \T_Z) \to (Z/\cong, \T_{Z/\cong})$ is 
        \OpenFunction. 
        \item 
        \label{prop:QST:QuotientMapClosed}
        $T:(Z, \T_Z) \to (Z/\cong, \T_{Z/\cong})$ is 
        \ClosedFunction.
        \item 
        \label{prop:QST:Compact}
        $(Z, \T_Z)$ is a \SetCompact space if and only if 
        $(Z/\cong, \T_{Z/\cong})$ is a \SetCompact space.
        \item 
        \label{prop:QST:Basis}
        If $\scB$ is a \TopologyBasis for $\T_z$, 
        then $\{T(U) : U \in \scB\}$ is a \TopologyBasis for $\T_{Z/\cong}$. 
        \item 
        \label{prop:QST:Injective}
        If T is \Injective, then it is a \Homeomorphism. 
    \end{enumerate} 
    \begin{proof}[Proof of \ref{prop:QST:IsTop}]
        ...
        \end{equation*}
    \end{proof}
    \begin{proof}[Proof of \ref{prop:QST:QuotientMapContinuous}]
        Let $V \in \T_{Z/\cong}$. 
        Let $x_0 \in T^{-1}(V)$. 
        Then $[x_0] \in V$. 
		...
		\RelationOfEqualNeighborhoodFilters{Z}
		implies $\scU(x_0)=\scU(y_0)$. 
        Hence, $x_0 \in U \subset T^{-1}(V)$.
    \end{proof}
    \begin{proof}[Proof of \ref{prop:QST:OpenSetsPartition}]
        Let $K$ be \SetClosed in $(Z,\T_Z)$. 
        Then to each point $x_0 \in Z \setminus K$ 
        there corresponds a \Neighborhood $U_{x_0}$ of $x_0$
        \Disjoint from $K$.
        Hence $y_0 \not \cong x_0$ for any $y_0 \in K$, 
        Hence $T(K)$ is 
		\Disjoint 
    ...
    \end{proof}
    \begin{proof}[Proof of \ref{prop:QST:OpenSetFiber}]
        Let $U \in \T_Z$. 
    ...
    \end{proof}
    \begin{proof}[Proof of \ref{prop:QST:ClosedSetFiber}]
        Let K be 
		\SetClosed 
		in $(Z,\T_Z)$. 
        Part \ref{prop:QST:OpenSetsPartition}
        Of this result implies $Z/\cong$ is partitioned by $T(K)$ and $T(Z\setminus K)$. 
        Hence, $T(K) = T(Z) \setminus T(Z \setminus K)$
        
        By 
        \ref{prop:QST:OpenSetFiber},
        \begin{align*}
        ...
        \end{align*}      
    \end{proof}
    \begin{proof}[Proof of \ref{prop:QST:QuotientMapOpen}]
        Let $U \in \T_Z$.
        ...
        which is open.
    \end{proof}  
    \begin{proof}[Proof of \ref{prop:QST:QuotientMapClosed}] 
        Let K be \SetClosed in $(Z,\T_Z)$. 
        Then $Z \setminus K \in \T_Z$. 
        By \ref{prop:QST:OpenSetsPartition} and 
        \ref{prop:QST:ClosedSetFiber}, we know $T(K) = Z/\cong \setminus T(Z\setminus K)$ and also that $T(Z\setminus K) \in \T_{Z/\cong}$. Hence $T(K)$ is \SetClosed in $(Z/\cong, \T_{Z/\cong})$. 
    \end{proof} 
    \begin{proof}[Proof of \ref{prop:QST:Compact}]
        Let $(Z,\T_Z)$ be \SetCompact. 
        Let $\{U_{\alpha}\}_{\alpha \in A}$ be an \SetOpen covering of $(Z/\cong, \T_{Z/\cong})$. 
        Then $\{T^{-1}\pa{U_{\alpha}} : \alpha \in A\}$ is an \SetOpen covering of $(Z, \T_Z)$. 
        \SetCompactness of $(Z, \T_Z)$ guarantees the existence of a finite subcovering $\{T^{-1}\pa{U_{\alpha_i}}\}_{i=1}^n$. 
        Hence
        $\{U_{\alpha_i} \}_{i=1}^n=\{TT^{-1}(U_{\alpha_i})\}_{i=1}^n$ is an 
		\SetOpen
        \Cover of $(Z/\cong, \T_{Z/\cong})$. 
        Hence, the \SetCompactness of $(Z/\cong, \T_{Z/\cong})$ is verified. 
		 ...
		 \SetCompactness has a \Finite \Subcover $\{T(V_{\beta_i}) \}_{i=1}^n$. 
        By \ref{prop:QST:OpenSetFiber}, 
         $\{V_{\beta_i}\}_{i=1}^n = \{T^{-1}(T(V_{\beta_i}))\}_{i=1}^n$ is then an \SetOpen \Subcover of $(Z, \T_Z)$. 
     %    
    \end{proof}
    \begin{proof}[Proof of \ref{prop:QST:Basis}]
        ...
        \end{align*}
     \end{proof} 
     \begin{proof} [Proof of \ref{prop:QST:Injective}]
            If T is \Injective
			, then since it is 
            \ContinuousFunction
            by 
            ...
            open by 
            \ref{prop:QST:QuotientMapOpen}, and \Surjective by \ref{prop:QuotientMapSurjective}, it is a 
            \Homeomorphism. 
         \end{proof}
\end{prop} 
