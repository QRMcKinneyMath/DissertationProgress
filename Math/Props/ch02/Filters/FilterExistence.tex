\begin{prop}
\label{prop:FilterExistence}\rm
    Let $X$ be a nonempty set.
    Let $A \subset 2^X$ be nonempty.
    Then there is a \Filter
    on $X$ which contains $A$ if and only if 
    any \Finite intersection of elements of $A$ 
    is nonempty.
    Furthermore, if there is a \Filter 
    containing $A$, then there is a 
    \CoarsestFilter \Filter containing A, 
    and it is given by the collection of all subsets of $X$ 
    which contain some finite intersection of elements of $A$.
    \begin{proof}
        The given condition is necessary by a combination 
        of \ref{prop:FilterFacts:ContainsX} and \ref{def:Filter:DoesntContainEmpty}.
        For sufficiency,
        let $K$ be the collection of finite intersections
        of elements of $A$. 
        Define 
        \begin{equation*}
        \scK = \{ F \cup Y : F \in K \wedge Y \subset X\}
        \end{equation*}
        Then $A \subset \scK$. 
        Since $A \neq \emptyset$, $\scK \neq \emptyset$, 
        ...
        $\emptyset \not \in \scK$, so $\ref{def:Filter:DoesntContainEmpty}$ holds. 
        Let $P \in \scK$ and let $P \subset Q \subset X$.
        ...
        Clearly $U_1 \cap U_2$, being a finite intersection of 
        elements of $A$, is an 
        element of $K$. 
        Furthermore, 
        \begin{align*}
        ...
        By \ref{prop:FilterFacts:ClosureUnderFiniteIntersections}, any \Filter containing $A$ 
        would contain $K$. By $\ref{def:Filter:SubsetProperty}$, any \Filter containing $A$ 
        would contain $\scK$, so any \Filter on $X$ containing $A$ would be \FinerFilter than 
        $\scK$, and so $\scK$ is the \CoarsestFilter \Filter containing $A$. 
