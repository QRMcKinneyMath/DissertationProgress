\begin{prop}[Filter Base Facts]
\label{prop:FilterBaseFacts}\rm
   ...
   Define  $\scB$ to be the collection of all finite intersections of elements of $A$.
   ...
   Since $\emptyset \not \in \scB$ is closed under finite intersections, if $U,V \in \scB$, then $\emptyset \neq U \cap V \in \scB$, so $\scB$ can be seen to satisfy $\ref{def:FilterBase:IntersectionProperty}$. Hence $\scB$ is a \FilterBase. 
   Since $A \subset \scB$, $\scB$ is a \FilterBase for a \FinerFilter \Filter than $\scF$. 
   ...
   \begin{proof}[Proof of \ref{prop:FilterBaseFacts:BaseCondition}]
    ...
    Hence, by  \ref{prop:FilterBase}, $B$ is a \FilterBase for $\scF$. 
   ...
   \begin{equation*}
   G \subset \scG \subset \scF = \{ U \subset X : (\exists f \in F) (f \subset U) \}
   \end{equation*}
   which is the desired result in one direction. 
   The other direction is by applying  applying \ref{prop:FilterBase}
   to claim
