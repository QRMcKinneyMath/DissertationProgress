\begin{prop}[Filter Order Facts]
    ...
    Let $\scK=\{\scF_\alpha\}_{\alpha \in A}$ be a collection of $\Filters$ on $X$. 
    ...
    \begin{proof}[Proof of \ref{prop:FilterOrderFacts:ContainingFilter}]
        ...
        there is a \Filter containing $\scK$ if and only if 
        $\emptyset \not \in \scL$.
    \end{proof}
    ...
    \begin{proof}[Proof of \ref{prop:FilterOrderFacts:FilterFinenessIsInductive}]
        This is proven by a direct application of  
