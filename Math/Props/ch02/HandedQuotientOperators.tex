...
\label{prop:handedquotientoperators}\rm
    Let X and Y be 
    \SeminormedSpaces
    with \CodomainQuotientMap $\scQ_Y$. 
    The following are true. 
    \begin{enumerate}
        \item $\scQ_Y$ is a well defined \ContinuousFunction \Linear  \Surjective \Isometry. 
        \item If Y is a \NormedSpace, then $\scQ_Y$ is invertible with a \ContinuousFunction inverse. 
    \end{enumerate}
