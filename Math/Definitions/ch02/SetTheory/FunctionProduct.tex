\newcommand{\FunctionProduct}[0]{
    \textbf{\hyperref[def:FunctionProduct]{Function Product}}    
}
\newcommand{\FunctionProducts}[0]{
    \textbf{\hyperref[def:FunctionProduct]{Function Products}}    
}
