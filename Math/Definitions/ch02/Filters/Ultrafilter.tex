...
\newcommand{\UltrafilterBase}[0]{
    \textbf{\hyperref[def:Ultrafilter]{Ultrafilter Base}}
}
\newcommand{\UltrafilterBases}[0]{
    \textbf{\hyperref[def:Ultrafilter]{Ultrafilter Bases}}
}
