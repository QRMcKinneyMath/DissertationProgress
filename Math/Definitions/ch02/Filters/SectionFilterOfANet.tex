\newcommand{\NetSectionFilter}[0]{
    \textbf{\hyperref[def:SectionFilter]{Section Filter}}
}
\newcommand{\NetSectionFilters}[0]{
    \textbf{\hyperref[def:SectionFilter]{Section Filters}}
}
\newcommand{\DirectedSectionFilter}[0]{
    \textbf{\hyperref[def:SectionFilter]{Section Filter}}
}
\newcommand{\DirectedSectionFilters}[0]{
    \textbf{\hyperref[def:SectionFilter]{Section Filters}}
}
