...
\begin{df}[Space of Continuous Linear Operators]
\label{def:BLO} 
\rm
...
of pointwise \ScalarMultiplication
and pointwise \VectorAddition, making $BL\pa{X,Y}$ a \VectorSpace. 
...
In the case that $\norm{\cdot}_{Y}$ is a \Norm, rather than just a \Seminorm, 
by \ref{prop:BLO}, 
