...
\rm
    ...
    \Linear, 
    \Bijective, 
    \Isometry which operates \Homeomorphically.
    ...
    \begin{proof}
        ...
        which is a \Linear \Isometric \Homeomorphism in this case
        by parts 4, 5, 6, and 7 of 
        of \ref{prop:quotientnormspace}, 
        $\Theta$ is the \CanonicalIso, 
        which is a \Linear \Isometric \Homeomorphism by
        \ref{prop:canonicalisomorphism}
        and $\scQ_{\F}$ is the \CodomainQuotientMap.
        which is in this case a \Linear, \Isometric \Homeomorphism
        ...
        $\Omega$ is also a 
        \Linear \Isometric \Homeomorphism.
    \end{proof}
\end{thm}
